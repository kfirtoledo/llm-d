...
| Tiered prefix cache **L3/L4** (lmcache/lustre/mooncake) | 🔄 Partial — **fs/Lustre L3 ✅ merged** ([#2093](https://github.com/llm-d/llm-d/pull/2093)); mooncake pending | 0.9 | [#1967](https://github.com/llm-d/llm-d/issues/1967) (lustre, ✅), [#1980](https://github.com/llm-d/llm-d/issues/1980) (mooncake); router [#1010](https://github.com/llm-d/llm-d-router/issues/1010) closed |
| **P2P KV pull — `offloading` connector** 🆕 | ✅ Done | 0.9 | router [#1888](https://github.com/llm-d/llm-d-router/pull/1888) + DP [#2075](https://github.com/llm-d/llm-d-router/pull/2075) |
